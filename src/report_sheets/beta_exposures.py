...
def increase_size(worksheet_chart):
    try:
        ...
        MyExceptions.show_message(tab='beta_exposures.py',
                                  message="Following exception occurred during increasing the size of chart\n\n" + str(
                                      ex))
    finally:
...
def generate_beta_exposures_sheet(
    ...
    try:
        ...
        MyExceptions.show_message(tab='beta_exposures.py',
                                  message="Following exception occurred during setting the layout/header\n\n" + str(
                                      ex))
