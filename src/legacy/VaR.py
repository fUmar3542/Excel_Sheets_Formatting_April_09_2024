...
def filter_stress_test_price_vol(
    ...
    stress_test_price_vol_df = None
    stress_test_price_vol_exposure_df = None
    dict_filtered = None
    try:
        '''add docstring'''
        ...
        MyExceptions.show_message(tab='VaR.py',
                                  message="Following exception occurred during calculating stress test data\n\n" + str(
                                      ex))
    finally:
...
def filter_stress_test_beta_price_vol(
    ...
    price_vol_shock_range: Dict,):
    stress_test_beta_price_vol_df = None
    try:
        ...
        MyExceptions.show_message(tab='VaR.py',
                                  message="Following exception occurred during calculating filter beta stress test data\n\n" + str(
                                      ex))
    finally:
...
def stress_test_structuring(
    ...
    try:
        ...
        MyExceptions.show_message(tab='VaR.py',
                                  message="Following exception occurred during calculating stress test results\n\n" + str(
                                      ex))
    finally:
...
def stress_test_filtered_structuring(stress_test_filtered_calc, firm_NAV):
    ...
    try:
        ...
        MyExceptions.show_message(tab='VaR.py',
                                  message="Following exception occurred during calculating stress test filtering\n\n" + str(
                                      ex))
    finally:
