...
def DD_Abs(X):
    ...
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during draw down of return series\n\n" + str(
                                      ex))
    finally:
...
def MDD_Abs(X):
    ...
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during maximum draw down of return series\n\n" + str(
                                      ex))
    finally:
        return maxDD
...
def clean_nav(aum: pd.DataFrame, firm_wide: bool) -> pd.DataFrame:
    ...
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during cleaning nav\n\n" + str(
                                      ex))
    finally:
        return daily_nav
...
def convert_aum_columns(aum: pd.DataFrame) -> pd.DataFrame:
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during conversion of aum columns\n\n" + str(
                                      ex))
    finally:
        return aum
...
def return_analysis(AUM: pd.DataFrame, holdings_date, FirmName) -> pd.DataFrame:
    ...
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during return analysis\n\n" + str(
                                      ex))
    finally:
        return res
...
def single_return_analysis(AUM: pd.DataFrame, holdings_date, FirmName) -> pd.DataFrame:
    ...
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during calculating return analysis dataframe\n\n" + str(
                                      ex))
    finally:
...
def comparative_statistics(AUM: pd.DataFrame, return_analysis_df: pd.DataFrame, holdings_date, FirmName):
    ...
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during AUM comparative statistics\n\n" + str(
                                      ex))
    finally:
        return res
...
def single_comparative_statistics(AUM: pd.DataFrame, return_analysis_df: pd.DataFrame, FirmName):
    ...
    comparative_statistics_df = None
    try:
        if FirmName == "IBIS":
            bench_names =["SPX Index", "CCMP Index"]  #adds Nasdaq to list of benchmarks if IBIS
        elif FirmName == "CRM":
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during building comparative statistics dataframe\n\n" + str(
                                      ex))
    finally:
...
def monthly_pnl_stats(AUM: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        MyExceptions.show_message(tab='pnl_stats.py',
                                  message="Following exception occurred during calculating monthly rets\n\n" + str(
                                      ex))
    finally:
        return monthly_rets
