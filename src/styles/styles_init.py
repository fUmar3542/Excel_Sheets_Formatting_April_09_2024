...
def set_styles(workbook, temp=None) -> Dict[str, Any]:
    '''sets all necessary styles and returns a styles' dictionary'''
    styles_dict = {
        'table_header': ts.add_header_style(workbook, temp=temp),
        'table_total': ts.add_total_style(workbook),
        'table_total_pct': ts.add_total_pct_style(workbook),
        ...
        'precentage_round': ts.add_percentage_round_format(workbook),
        ...
        # 'my_value_format': ts.my_value_format(workbook),
    }
