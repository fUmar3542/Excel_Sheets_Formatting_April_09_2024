...
def insert_table(
    ...
    try:
        ...
        MyExceptions.show_message(tab='excel_utils.py',
...
def apply_conditional_formatting(
    ...
    try:
        ...
        MyExceptions.show_message(tab='excel_utils.py',
                                  message="Following exception occurred during applying conditional formatting\n\n" + str(
                                      ex))
...
def insert_dual_axis_chart(    workbook,    worksheet,     worksheet_chart_bars: WorksheetChart,     worksheet_chart_line: WorksheetChart) -> None:
    ...
    try:
        ...
        MyExceptions.show_message(tab='excel_utils.py',
                                  message="Following exception occurred during inserting dual charts into the sheet\n\n" + str(
                                      ex))
...
def _set_chart_object(
    ...
    try:
        ...
        MyExceptions.show_message(tab='excel_utils.py',
                                  message="Following exception occurred during setting the position of chart\n\n" + str(
                                      ex))
    finally:
...
def _add_column_series(worksheet_chart, chart, series_setter: Callable, y2_axis):
    ...
    try:
        ...
        MyExceptions.show_message(tab='excel_utils.py',
                                  message="Following exception occurred during adding column series into the sheet\n\n" + str(
                                      ex))
...
def _format_chart(worksheet_chart, chart):
    ...
    try:
        ...
        MyExceptions.show_message(tab='excel_utils.py',
                                  message="Following exception occurred during setting the table position\n\n" + str(
                                      ex))
    finally:
        return position
